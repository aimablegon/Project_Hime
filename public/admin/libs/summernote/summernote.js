  ...
  var VideoDialog = function (context) {
    ...
    this.createVideoNode = function (url) {
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = $("<div style='position: relative;width: 100%;height: 0;padding-bottom: 56.25%;'>");
        
        var $iframe = $('<iframe allowfullscreen style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;">')
        .attr('frameborder', 0)
        .attr('src', '//www.youtube.com/embed/' + youtubeId);
        $iframe.addClass('note-video-clip');
        $video.append($iframe);    
